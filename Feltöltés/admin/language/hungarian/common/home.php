...
// Error
$_['error_install']                 = 'Figylem: Az Install mappát biztonsági okokból el kell távolítani tárhelyéről';
$_['error_image']                   = 'Figylem: Image directory %s not writeable!';
$_['error_image_cache']             = 'Figylem: Image cache directory %s not writeable!';
$_['error_cache']                   = 'Figylem: Cache directory %s not writeable!';
$_['error_download']                = 'Figylem: Download directory %s not writeable!';
$_['error_logs']                    = 'Figylem: Log directory %s not writeable!';
?>